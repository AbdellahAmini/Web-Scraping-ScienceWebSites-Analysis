...
sys.stdout = open('nature_breast_cancer.txt', 'w', encoding='utf-8')
basedir = os.path.dirname(os.path.realpath('nature_breast_cancer.py'))

class nature_breast_cancer_Spider(scrapy.Spider):
# class nature_breast_cancer_Spider(scrapy.Spider):
    name = "nature_breast_cancer"
    allowed_domains = ["nature.com"]
    i = 2020
    j = 2023
    term = "(breast cancer AND Non-Coding RNA) OR (breast cancer AND lncRNA) OR (breast cancer AND miRNA) OR (breast cancer AND micro-RNA) OR (breast cancer AND mRNA)"
    ...
    def parse(self, response):
        ...
        output_file = "nature_breast_cancer.json"
        ...
        file_path = "nature_breast_cancer.json"
