...
sys.stdout = open('sciencedirect_amyotrophic_lateral_sclerosis.txt', 'w', encoding='utf-8')
basedir = os.path.dirname(os.path.realpath('sciencedirect_amyotrophic_lateral_sclerosis.py'))

class sciencedirect_amyotrophic_lateral_sclerosis_Spider(scrapy.Spider):
# class sciencedirect_amyotrophic_lateral_sclerosis_Spider(scrapy.Spider):
    name = "sciencedirect_amyotrophic_lateral_sclerosis"
    allowed_domains = ["sciencedirect.com"]
    a=2021
    b=2024
    term = "(amyotrophic lateral sclerosis   Non-Coding RNA) OR (amyotrophic lateral sclerosis   lncRNA) OR (amyotrophic lateral sclerosis   miRNA) OR (amyotrophic lateral sclerosis   micro-RNA) OR (amyotrophic lateral sclerosis   mRNA)"
    ...
    def parse(self, response):
        ...
        output_file = "sciencedirect_amyotrophic_lateral_sclerosis.json"
        ...
        file_path = "sciencedirect_amyotrophic_lateral_sclerosis.json"
