...
sys.stdout = open('sciencedirect_breast_cancer.txt', 'w', encoding='utf-8')
basedir = os.path.dirname(os.path.realpath('sciencedirect_breast_cancer.py'))

class sciencedirect_breast_cancer_Spider(scrapy.Spider):
# class sciencedirect_breast_cancer_Spider(scrapy.Spider):
    name = "sciencedirect_breast_cancer"
    allowed_domains = ["sciencedirect.com"]
    a=2021
    b=2024
    term = "(breast cancer   Non-Coding RNA) OR (breast cancer   lncRNA) OR (breast cancer   miRNA) OR (breast cancer   micro-RNA) OR (breast cancer   mRNA)"
    ...
    def parse(self, response):
        ...
        output_file = "sciencedirect_breast_cancer.json"
        ...
        file_path = "sciencedirect_breast_cancer.json"
