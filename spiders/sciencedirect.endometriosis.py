...
sys.stdout = open('sciencedirect_endometriosis.txt', 'w', encoding='utf-8')
basedir = os.path.dirname(os.path.realpath('sciencedirect_endometriosis.py'))

class sciencedirect_endometriosis_Spider(scrapy.Spider):
# class sciencedirect.endometriosis_Spider(scrapy.Spider):
    name = "sciencedirect_endometriosis"
    allowed_domains = ["sciencedirect.com"]
    a=2021
    b=2024
    term = "(endometriosis Non-Coding RNA) OR (endometriosis lncRNA) OR (endometriosis miRNA) OR (endometriosis micro-RNA) OR (endometriosis mRNA)"
    ...
    def parse(self, response):
        ...
        output_file = "sciencedirect_endometriosis.json"
        ...
        file_path = "sciencedirect_endometriosis.json"
