...
sys.stdout = open('nature_endometriosis.txt', 'w', encoding='utf-8')
basedir = os.path.dirname(os.path.realpath('nature_endometriosis.py'))

class nature_endometriosis_Spider(scrapy.Spider):
# class nature_endometriosis_Spider(scrapy.Spider):
    name = "nature_endometriosis"
    ...
    def parse(self, response):
        ...
        output_file = "nature_endometriosis.json"
        ...
        file_path = "nature_endometriosis.json"
