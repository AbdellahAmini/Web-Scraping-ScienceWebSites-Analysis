...
sys.stdout = open('nature_ovarian_cancer.txt', 'w', encoding='utf-8')
basedir = os.path.dirname(os.path.realpath('nature_ovarian_cancer.py'))

class nature_ovarian_cancer_Spider(scrapy.Spider):
# class nature_ovarian_cancer_Spider(scrapy.Spider):
    name = "nature_ovarian_cancer"
    allowed_domains = ["nature.com"]
    i = 2020
    j = 2023
    term = "(ovarian cancer AND Non-Coding RNA) OR (ovarian cancer AND lncRNA) OR (ovarian cancer AND miRNA) OR (ovarian cancer AND micro-RNA) OR (ovarian cancer AND mRNA)"
    ...
    def parse(self, response):
        ...
        output_file = "nature_ovarian_cancer.json"
        ...
        file_path = "nature_ovarian_cancer.json"
